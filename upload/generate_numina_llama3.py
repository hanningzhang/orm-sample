...
def parse_args():
    ...
    parser.add_argument("--model", type=str, default='meta-llama/Meta-Llama-3-8B-Instruct')  # model path
    ...
    parser.add_argument("--output_dir", type=str, default="numina_math/llama3_math_n256_temp1_seed42.json")
