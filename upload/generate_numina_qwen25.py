...
def parse_args():
    ...
    parser.add_argument("--model", type=str, default='Qwen/Qwen2.5-7B-Instruct')  # model path
    ...
    parser.add_argument("--output_dir", type=str, default="numina_math/qwen25_instruct_n256_temp1_seed42.json")
